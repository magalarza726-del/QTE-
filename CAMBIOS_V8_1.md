...
- Solo TAP; la mecánica HOLD fue eliminada por completo.
...
- Se retiró HOLD del editor de cartas.
- Se eliminó la barra de mantenimiento durante batalla.
- Se simplificó la entrada del control a una pulsación por acción.
- La IA ya no calcula tiempos de mantenimiento.
- Se retiró el bono de poder de 0,05 asociado a HOLD.
- Las acciones HOLD antiguas se migran automáticamente a TAP.
